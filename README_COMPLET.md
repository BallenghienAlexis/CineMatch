...
| Bonus | Status | Points |
|-------|--------|--------|
| Filtres par genre (dropdown TMDB) | ✅ | +1 pt |
| Animations Reanimated 3D (rotation + spring) | ✅ | +1 pt |
...
Projet académique SUP de VINCI — Tous droits réservés.

---

**Mis à jour** : 5 mai 2026  
**État** : ✅ Complété (toutes fonctionnalités + 2 bonus)  
**Score estimé** : 18/20 pts
